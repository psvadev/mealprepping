...
- **Batch day time estimate** — shows a prep time range per week (best case: longest single dish; worst case: all dishes back-to-back); helps gauge if the planned batch is realistic to cook in one day
