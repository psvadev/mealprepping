...
A browser-based weekly meal planner for a Norwegian family doing meal prep. No server, no build step — just a single `index.html` file served locally.

---

## Features

- **Weekly meal grid** — plan 1–4 weeks, drag-and-drop meals into days
